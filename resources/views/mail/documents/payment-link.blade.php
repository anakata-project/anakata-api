...
@section('body')
    ...
    <p style="margin: 18px 0;">
        <a href="{{ $link->url }}" style="display: inline-block; padding: 10px 18px; background: #2c4a3a; color: #f4efe4; text-decoration: none; letter-spacing: 0.08em; font-size: 13px;">Pay securely</a>
    </p>
