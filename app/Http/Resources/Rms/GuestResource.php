...
class GuestResource extends JsonResource
{
     ...
     *     medical_note: array{value: string|null, on_file: bool},
     *     dietary_note: array{value: string|null, on_file: bool},
     *     accessibility_note: array{value: string|null, on_file: bool},
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'medical_note' => Masking::note($this->medical_note, $canViewSensitive),
            'dietary_note' => Masking::note($this->dietary_note, $canViewSensitive),
            'accessibility_note' => Masking::note($this->accessibility_note, $canViewSensitive),
