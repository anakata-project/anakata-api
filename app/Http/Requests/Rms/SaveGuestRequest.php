...
class SaveGuestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'medical_note' => ['sometimes', 'nullable', 'string'],
            'dietary_note' => ['sometimes', 'nullable', 'string'],
            'accessibility_note' => ['sometimes', 'nullable', 'string'],
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            $existingDob = $existing instanceof Guest ? $existing->dob?->toDateString() : null;
            $existingExpiry = $existing instanceof Guest ? $existing->passport_expiry?->toDateString() : null;
