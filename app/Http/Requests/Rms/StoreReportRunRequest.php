...
class StoreReportRunRequest extends FormRequest
{
    ...
    {
        return new MetricWindow((string) $this->validated('from'), (string) $this->validated('to'));
    }
    ...
    /**
     * @return array{from: string, to: string, yacht: int|null, itinerary: int|null, channel: string|null, agency: int|null}
     */
