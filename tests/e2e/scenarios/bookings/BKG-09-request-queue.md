...
3. On ANK-R-2026-0041 click `Confirm · send deposit link`. Confirm modal: read the body and the Sprint 5 sentence. Submit `Confirm · send deposit link`.
...
- [ ] E3 · Confirm 0041: toast `Request confirmed`. Row gone. Badge **1**. Bookings list shows a `PENDING PAYMENT` row whose request reference is ANK-R-2026-0041 (booking ref ANK-2026-0020). ⚠ UNVERIFIED — G3 assigns ANK- on confirm; next ANK from Pest. Toast i18n `bookings.confirmedToast`.
