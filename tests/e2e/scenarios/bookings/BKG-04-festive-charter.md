...
5. Read the price box and the charter notice. `Create reservation`.
6. Open Calendar Year 2027, ANATIVA 19 Dec.
...
- [ ] E4 · Toast `Reservation ANK-2026-0020 created.` ⚠ UNVERIFIED — next ref from Pest; toast from `createdToast()`.
