...
## Expected
- [ ] E1 · Seed rows: Anna Whitfield · Suite · position **1**; K. Osei · Owner's Suite · position **1** (different categories). Departure 19 Dec festive. ⚠ UNVERIFIED — on-screen position column and Owner label `Owner's Suite`.
...
## Notes
Button is **Mark notified** (G7), not the prototype’s “Notify now”. 19 Dec ANAMARA is the seeded charter (FULL).
